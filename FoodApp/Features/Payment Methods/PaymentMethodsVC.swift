...
//        table.register
    ...
    private lazy var addNewCardButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(addNewCardButtonTouchDown), for: .touchDown)
        button.addTarget(self, action: #selector(addNewCardButtonTouchUp), for: [.touchUpInside, .touchUpOutside, .touchCancel])
    ...
    @objc
    private func addNewCardButtonTouchDown() {
    ...
    @objc
    private func addNewCardButtonTouchUp() {
